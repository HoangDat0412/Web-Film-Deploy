...
onMounted(async () => {
  console.log(film.listFilmType);

  await film.fetchMoviesToprate(1);
});
...
const handleSearchFilter = async () => {
  ...
  await film.searchMoviesToprate(data, 1);
};
</script>
...
<template>
  <div class="container mb-4 mt-2 min-h-80">
    ...
    <h1 class="text-2xl mb-4">Phim có đánh giá cao nhất</h1>
...
<style scoped>
@import url("./FilmToprateView.scss");
</style>
